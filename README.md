...
- **[md-engine](https://github.com/JEFF7712/md-engine)** - A high-performance Molecular Dynamics (MD) engine written in C++ and CUDA.
- **[nix-agent](https://github.com/JEFF7712/nix-agent)** - Agent MCP server + skill for managing your NixOS system 
- **[nixos-config](https://github.com/JEFF7712/nixos-config)** - My NixOS configuration
...
- **[spatia](https://spatia.rupan.dev/)** - Interior Design AI App
